...
from generation import generate_controled_path
...
surface_plotter(s_set, t_set,V_matrix, title="Value Surface", filename="V_surface.png")
...
surface_plotter(s_set[idx_S_min:idx_S_max], t_set[:-1],zeta[idx_S_min:idx_S_max,:-1], title="Zeta Optimal Control Surface", filename="S_surface.png")
