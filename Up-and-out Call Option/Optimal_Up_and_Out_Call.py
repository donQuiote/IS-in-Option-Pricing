...
for grid_param in grid_params:
    ...
    #surface_plotter(s_set, t_set,V_matrix, title="Value Surface", filename="../Graphs/V_surface_UOC.png")
    ...
    #plot_MC_Analytical(analytical_price=Up_Out_price, numerical_prices_avg=numerical_prices_avg_opt_control, numerical_prices_std=numerical_prices_std_opt_control, sample_sizes=Ns, nbr_iterations = nbr_iterations, confidence_level=0.95, filename="../Graphs/MC_UOCO_Optimal_Controlled", title="Monte Carlo up-and-out call price estimation with optimal control")
